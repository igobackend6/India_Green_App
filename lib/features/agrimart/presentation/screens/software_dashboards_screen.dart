...
class SoftwareDashboardsScreen extends ConsumerWidget {
  const SoftwareDashboardsScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final items = [
      (
        title: 'IGO Farm ERP (Enterprise)',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Software & Dashboards'),
