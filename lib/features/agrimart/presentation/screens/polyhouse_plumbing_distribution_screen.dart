...
class PolyhousePlumbingDistributionScreen extends ConsumerWidget {
  const PolyhousePlumbingDistributionScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final subProjects = [
      (
        title: 'Industrial Manual Disc Filter',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Plumbing & Distribution'),
...
class _PolyhouseItemCard extends StatefulWidget {
  final String title;
  ...
  @override
  State<_PolyhouseItemCard> createState() => _PolyhouseItemCardState();
}

class _PolyhouseItemCardState extends State<_PolyhouseItemCard> {
