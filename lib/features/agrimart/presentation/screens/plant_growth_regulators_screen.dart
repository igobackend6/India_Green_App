...
class PlantGrowthRegulatorsScreen extends ConsumerWidget {
  const PlantGrowthRegulatorsScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final subProjects = [
      (
        title: 'Nitro-Bloom Stimulant',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Plant Growth Regulators'),
...
class _PGRItemCard extends StatefulWidget {
  final String title;
  ...
  @override
  State<_PGRItemCard> createState() => _PGRItemCardState();
}

class _PGRItemCardState extends State<_PGRItemCard> {
