...
class IotHardwareNodesScreen extends ConsumerWidget {
  const IotHardwareNodesScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final items = [
      (
        title: 'SmartFarm Soil Health Node',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('IOT Hardware & Nodes'),
