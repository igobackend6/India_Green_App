...
class EnvironmentalControllersScreen extends ConsumerWidget {
  const EnvironmentalControllersScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final items = [
      (
        title: 'IGO-Link SmartHub',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Environmental Controllers'),
