...
class GrowingMediaScreen extends ConsumerWidget {
  const GrowingMediaScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final subProjects = [
      (
        title: 'Premium Buffered Cocopeat',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Growing Media & Substrates'),
