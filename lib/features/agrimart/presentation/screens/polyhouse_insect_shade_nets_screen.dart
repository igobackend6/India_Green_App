...
class PolyhouseInsectShadeNetsScreen extends ConsumerWidget {
  const PolyhouseInsectShadeNetsScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final subProjects = [
      (
        title: 'Anti-Insect Net(40 Mesh)',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Insect & Shade Nets'),
