...
class PolyhouseMistingFoggingScreen extends ConsumerWidget {
  const PolyhouseMistingFoggingScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final subProjects = [
      (
        title: 'Mist-Cool High Pressure Kit',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Misting & Fogging'),
