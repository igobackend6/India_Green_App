  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final subProjects = [
      (
        ...
        url: 'https://www.igoagritechfarms.in/products/agri-inputs/leafy-seeds/seed-basil',
      ),
      (
        ...
        url: 'https://www.igoagritechfarms.in/products/agri-inputs/leafy-seeds/seed-parsley',
      ),
      (
        title: 'Kale Seeds',
        icon: Icons.grass_rounded,
        ...
        url: 'https://www.igoagritechfarms.in/products/agri-inputs/leafy-seeds/seed-kale',
      ),
      (
        ...
        url: 'https://www.igoagritechfarms.in/products/agri-inputs/leafy-seeds/seed-amaranth',
      ),
      (
        ...
        url: 'https://www.igoagritechfarms.in/products/agri-inputs/leafy-seeds/seed-fenugreek-leafy',
      ),
      (
        ...
        url: 'https://www.igoagritechfarms.in/products/agri-inputs/leafy-seeds/seed-lettuce-leafy',
      ),
      (
        ...
        url: 'https://www.igoagritechfarms.in/products/agri-inputs/leafy-seeds/seed-mint',
      ),
      (
        title: 'Dill Seeds',
        icon: Icons.grass_rounded,
        ...
        url: 'https://www.igoagritechfarms.in/products/agri-inputs/leafy-seeds/seed-dill',
      ),
      (
        ...
        url: 'https://www.igoagritechfarms.in/products/agri-inputs/leafy-seeds/seed-arugula',
      ),
      (
        ...
        url: 'https://www.igoagritechfarms.in/products/agri-inputs/leafy-seeds/seed-swisschard',
      ),
      (
        ...
        url: 'https://www.igoagritechfarms.in/products/agri-inputs/leafy-seeds/seed-mustardgreens',
      ),
      (
        ...
        url: 'https://www.igoagritechfarms.in/products/agri-inputs/leafy-seeds/seed-spinach-leafy',
      ),
    ];
