...
class PolyhouseGreenhouseCoveringScreen extends ConsumerWidget {
  const PolyhouseGreenhouseCoveringScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final subProjects = [
      (
        title: 'UV Stabilized Polyethylene Filim',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Greenhouse Covering'),
