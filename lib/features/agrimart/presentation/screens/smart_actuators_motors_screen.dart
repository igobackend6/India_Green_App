...
class SmartActuatorsMotorsScreen extends ConsumerWidget {
  const SmartActuatorsMotorsScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final items = [
      (
        title: 'Precision Vent Actuator',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Smart Actuators & Motors'),
