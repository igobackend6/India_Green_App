...
class PolyhouseStructuralFramesScreen extends ConsumerWidget {
  const PolyhouseStructuralFramesScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final subProjects = [
      (
        title: 'GI Structural Pipes',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Structural Frames & Parts'),
