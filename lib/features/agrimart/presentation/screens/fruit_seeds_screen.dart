  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final subProjects = [
      (
        ...
        url: 'https://www.igoagritechfarms.com/products/agri-inputs/fruit-seeds/seed-mango',
      ),
      (
        title: 'Papaya Seeds',
        icon: Icons.apple_rounded,
        ...
        url: 'https://www.igoagritechfarms.com/products/agri-inputs/fruit-seeds/seed-papaya',
      ),
      (
        title: 'Guava Seeds',
        icon: Icons.apple_rounded,
        ...
        url: 'https://www.igoagritechfarms.com/products/agri-inputs/fruit-seeds/seed-guava',
      ),
      (
        title: 'Lemon Seeds',
        icon: Icons.apple_rounded,
        ...
        url: 'https://www.igoagritechfarms.com/products/agri-inputs/fruit-seeds/seed-lemon',
      ),
      (
        ...
        url: 'https://www.igoagritechfarms.com/products/agri-inputs/fruit-seeds/seed-pomegranate',
      ),
      (
        ...
        url: 'https://www.igoagritechfarms.com/products/agri-inputs/fruit-seeds/seed-chikoo',
      ),
      (
        ...
        url: 'https://www.igoagritechfarms.com/products/agri-inputs/fruit-seeds/seed-custardapple',
      ),
    ];
