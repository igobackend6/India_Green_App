...
class DosingFertigationScreen extends ConsumerWidget {
  const DosingFertigationScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final items = [
      (
        title: 'IGO FertiMix Classic (3 - Channel)',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Dosing & Fertigation'),
