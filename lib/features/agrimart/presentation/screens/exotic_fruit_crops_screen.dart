...
class ExoticFruitCropsScreen extends ConsumerWidget {
  const ExoticFruitCropsScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final items = [
      (
        title: 'Elite Grafted Fruit Plant Combo',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Exotic Fruit Crops'),
