...
class VegetableCropsScreen extends ConsumerWidget {
  const VegetableCropsScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final items = [
      (
        title: 'Hybrid Capsicum Seeds(Indra)',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Vegetable Crops'),
