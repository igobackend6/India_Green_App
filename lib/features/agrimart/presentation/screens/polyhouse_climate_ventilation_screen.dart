...
class PolyhouseClimateVentilationScreen extends ConsumerWidget {
  const PolyhouseClimateVentilationScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final subProjects = [
      (
        title: 'IGO Industrial Exhaust Fan(50)',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Climate & Ventilation'),
