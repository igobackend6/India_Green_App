...
class PlantNutritionScreen extends ConsumerWidget {
  const PlantNutritionScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Plant Nutrition & Fertilizers'),
...
class _NutritionItemCard extends StatefulWidget {
  final String title;
  ...
  @override
  State<_NutritionItemCard> createState() => _NutritionItemCardState();
}

class _NutritionItemCardState extends State<_NutritionItemCard> {
