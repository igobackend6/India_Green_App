...
class LivestockEcosystemsScreen extends ConsumerWidget {
  const LivestockEcosystemsScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final items = [
      (
        title: 'IGO Premium Cattle Feed',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('LiveStock Ecosystems'),
